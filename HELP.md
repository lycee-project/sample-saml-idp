...
* The original package name 'net.coolblossom.sample.saml.sample-saml-idp' is invalid and this project uses 'net.coolblossom.sample.saml.samplesamlidp' instead.
